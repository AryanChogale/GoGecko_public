...
class ProductSeeder extends Seeder
{
    ...
    {
        $products = [
            ['name' => 'Brown Kraft Paper Box', 'category' => 'Packaging Products', 'sub_category' => 'Boxes', 'price' => 45, 'description' => 'Durable kraft paper box suitable for food and retail packaging. Available in multiple sizes.', 'image' => 'products/kraft_box.jpg'],
            ['name' => 'Corrugated Shipping Box', 'category' => 'Packaging Products', 'sub_category' => 'Boxes', 'price' => 85, 'description' => 'Heavy-duty corrugated box for safe shipping and storage of goods.', 'image' => 'products/corrugated_shipping_box.jpeg'],
            ['name' => 'Bubble Wrap Roll (50m)', 'category' => 'Packaging Products', 'sub_category' => 'Wrapping', 'price' => 320, 'description' => 'Premium bubble wrap roll providing excellent cushioning for fragile items.', 'image' => 'products/bubble_wrap_roll.jpg'],
            ['name' => 'Stretch Wrap Film', 'category' => 'Packaging Products', 'sub_category' => 'Wrapping', 'price' => 210, 'description' => 'Clear stretch film for securing pallets and bundling products together.', 'image' => 'products/stretch_wrap_film_pallet.jpg'],
            ['name' => 'Packing Tape (Set of 6)', 'category' => 'Packaging Products', 'sub_category' => 'Tapes', 'price' => 120, 'description' => 'Strong adhesive packing tape for sealing cartons and packages securely.', 'image' => 'products/packing_tape_brown.jpeg'],
            ['name' => 'Zip Lock Bags (100 pcs)', 'category' => 'Packaging Products', 'sub_category' => 'Pouches', 'price' => 95, 'description' => 'Food-grade zip lock bags in assorted sizes for storage and packaging.', 'image' => 'products/zip_lock_bags_clear.jpg'],
            ['name' => 'Foam Packing Sheets', 'category' => 'Packaging Products', 'sub_category' => 'Wrapping', 'price' => 180, 'description' => 'Soft foam sheets for wrapping and protecting delicate products during transit.', 'image' => 'products/Foam_packing_sheets.jpg'],

            ['name' => 'Premium Ball Pen Set', 'category' => 'Corporate Gifting', 'sub_category' => 'Stationery', 'price' => 299, 'description' => 'Set of 5 smooth-writing ball pens in a gift box. Ideal for corporate giveaways.', 'image' => 'products/Ball_pen.jpg'],

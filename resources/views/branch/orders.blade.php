    ...
    <div class="min-h-screen bg-[#E9EFE5] py-10">
        <div class="max-w-6xl mx-auto px-6">
            ...
            <div class="mb-8">
                ...
                <p class="text-sm text-gray-500 mt-1">Orders assigned to your branch</p>
            </div>
                        ...
                        <div class="grid grid-cols-3 divide-x divide-gray-100">
                            ...
                            <div class="px-6 py-5">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="pt-2 border-t border-gray-100 flex justify-between text-sm">
                                        ...
                                        <span class="font-bold text-[#076807]">₹{{ number_format($order->total_amount, 2) }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="px-6 py-5">
                                ...
                                @if ($order->address)
                                    ...
                                    <p class="text-xs text-gray-400">💬 {{ $order->address->whatsapp }}</p>
                                @else
                            ...
                            <div class="px-6 py-5">
                                ...
                                @if ($order->status !== 'delivered' && $order->cancellation_status !== 'approved')
                                    <form method="POST"
                                          action="{{ route('branch.orders.updateStatus', $order) }}"
                                ...
                                @if ($order->cancellation_requested && $order->cancellation_status === 'pending')
                                    <div class="bg-red-50 rounded-lg p-3">
                                        ...
                                        <div class="flex gap-2">
                                            <form method="POST" action="{{ route('branch.orders.approveCancellation', $order) }}">
                                                @csrf
                                                <button type="submit"
                                            ...
                                            <form method="POST" action="{{ route('branch.orders.rejectCancellation', $order) }}">
                                                @csrf
                                                <button type="submit"
            ...
            @empty
                <div class="bg-white rounded-xl p-16 text-center border border-gray-100">
                    <p class="text-gray-400">No orders assigned to your branch yet.</p>
                </div>
            @endforelse

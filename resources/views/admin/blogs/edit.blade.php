<x-app-layout>
                ...
                <div class="grid grid-cols-3 gap-6">
                    ...
                    <div class="col-span-2 space-y-5">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="text" name="category" id="blog-category-input"
                                               value="{{ old('category', $blog->category_name) }}"
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                            ...
                            <input type="hidden" name="content" id="content-input" value="{{ old('content', $blog->editor_content) }}">
                            <div id="editor"
    ...
    <script>
        ...
        const initialContent = @json(old('content', $blog->editor_content));
        if (initialContent) {
            quill.clipboard.dangerouslyPasteHTML(initialContent);
        }

        document.querySelector('form[action="{{ route('admin.blogs.update', $blog) }}"]').addEventListener('submit', function () {
